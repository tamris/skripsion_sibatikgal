...
class DetailStudioCanvas extends GetView<StudioCanvasPageController> {
  const DetailStudioCanvas({super.key});
      ...
      body: GetBuilder<StudioCanvasPageController>(
        builder: (controller) {
          ...
          if (currentBatik == null) {
            return const Center(
              child: Text("Belum ada data sketsa batik yang dipilih."),
            );
          }
                      ...
                      return InteractiveViewer(
                        ...
                        child: Center(
                          child: SizedBox(
                            ...
                            child: Stack(
                              children: [
                                // Layer 1: Panduan Sketsa Latar Belakang Garis dari Backend Flask
                                Positioned.fill(
                                  child: Opacity(
                                    opacity: 0.35,
                                    child: Image.network(
                                      ...
                                      fit: BoxFit.contain,
                                      // 🟢 MENGGANTI SPINNER LAMA DENGAN EFEK SHIMMER KAIN BLANK
                                      loadingBuilder:
                                ...
                                // Layer 2: Papan Menggambar Interaktif (Otomatis merender draf JSON)
                                Positioned.fill(
                                  child: IgnorePointer(
                                    ignoring: !isDrawMode,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // BARIS KONTROL UKURAN + GRUP TOMBOL ALAT AKTIF
                    Row(
                      children: [
                        const Icon(
                          Icons.line_weight,
  ...
  // --- Widget Generator Kontrol Tombol ---
  Widget _toolButton({
